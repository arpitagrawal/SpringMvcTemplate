 ...
 ******************************************************************************/
package com.mradul.template.rest.controllers;
...
public class ProductController {
	...
	@ResponseStatus(HttpStatus.OK)
	@ResponseBody
	public Product getProduct(@PathVariable Integer id) throws DataAccessException {
	...
	@ResponseStatus(HttpStatus.OK)
	@ResponseBody
	public Product deleteProduct(@PathVariable Integer id) throws DataAccessException {
